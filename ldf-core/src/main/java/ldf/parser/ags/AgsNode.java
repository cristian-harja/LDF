...
public class AgsNode implements Iterable<AgsNode> {
    ...
    /**
     * @return AGS node associated with a {@link BnfItem}.
     */
    @Nonnull
    ...
    /**
     * @return AGS node associated with a {@link BnfAtom}.
     */
    @Nonnull
    ...
    /**
     * @return AGS node associated with a {@link BnfUnion}.
     */
    @Nonnull
    ...
    /**
     * @return AGS node associated with a {@link BnfConcat}.
     */
    @Nonnull
