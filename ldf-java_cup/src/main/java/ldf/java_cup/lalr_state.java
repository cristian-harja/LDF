 ...
 *
 * @see     ldf.java_cup.lalr_item
 * @see     ldf.java_cup.lalr_item_set
 * @see     ldf.java_cup.lalr_transition
...
public class lalr_state {
   ...
   * @see   ldf.java_cup.lalr_item_set#compute_closure
   * @see   ldf.java_cup.lalr_state#propagate_all_lookaheads
   */
