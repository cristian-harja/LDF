...
/** CUP v0.11b beta 20140226 generated parser.
  * @version Sun Mar 02 04:47:42 EET 2014
  */
public class parser extends ldf.java_cup.runtime.lr_parser {

  /** Default constructor. */
  public parser() {super();}

  /** Constructor which sets the default scanner. */
  public parser(ldf.java_cup.runtime.Scanner s) {super(s);}

  /** Constructor which sets the default scanner. */
  public parser(ldf.java_cup.runtime.Scanner s, ldf.java_cup.runtime.SymbolFactory sf) {super(s,sf);}
  ...
  public ldf.java_cup.runtime.Symbol do_action(
    int                        act_num,
    ldf.java_cup.runtime.lr_parser parser,
  ...
  public ldf.java_cup.runtime.Symbol scan()
    throws java.lang.Exception
    {
...
@SuppressWarnings({"UnusedAssignment","UnusedDeclaration","ConstantConditions","UnnecessaryLocalVariable"})
...
// TUM CHANGES
  ...
  protected Hashtable<String, symbol_part> symbols = new
          Hashtable<String, symbol_part>();

  /** table of just non terminals -- contains non_terminals indexed by name */
  protected Hashtable<String, non_terminal> non_terms = new
          Hashtable<String, non_terminal>();
  ...
  protected void add_precedence(String term) {
    if (term == null) {
      ...
      if (sp == null) {
        ...
        ldf.java_cup.symbol sym = sp.the_symbol();
  ...
  public final ldf.java_cup.runtime.Symbol CUP$parser$do_action_part00000000(
    int                        CUP$parser$act_num,
    ldf.java_cup.runtime.lr_parser CUP$parser$parser,
    java.util.Stack<Symbol>    CUP$parser$stack,
    int                        CUP$parser$top)
    throws java.lang.Exception
    {
      /* Symbol object for return from actions */
      ldf.java_cup.runtime.Symbol CUP$parser$result;
      ...
      switch (CUP$parser$act_num)
		...
		RESULT = start_val;
          ...
          non_terms.put("$START", non_terminal.START_nt);
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("NT$0",45, RESULT);
            }
          return CUP$parser$result;
          ...
          multipart_name = "";
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("NT$1",46, RESULT);
            }
          return CUP$parser$result;
          ...
          multipart_name = "";
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("NT$2",47, RESULT);
            }
          return CUP$parser$result;
		...
		String user_code = (String)CUP$parser$stack.elementAt(CUP$parser$top-1).value;
          ...
          multipart_name = "";
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("NT$3",48, RESULT);
            }
          return CUP$parser$result;
          ...
          multipart_name = "";
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("NT$4",49, RESULT);
            }
          return CUP$parser$result;
          ...
          multipart_name = "";
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("NT$5",50, RESULT);
            }
          return CUP$parser$result;
          ...
          multipart_name = "";
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("NT$6",51, RESULT);
            }
          return CUP$parser$result;
          ...
          update_precedence(assoc.left);
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("NT$7",52, RESULT);
            }
          return CUP$parser$result;
          ...
          update_precedence(assoc.right);
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("NT$8",53, RESULT);
            }
          return CUP$parser$result;
          ...
          update_precedence(assoc.nonassoc);
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("NT$9",54, RESULT);
            }
          return CUP$parser$result;
		...
		String sym = (String)CUP$parser$stack.peek().value;
          ...
          RESULT = sym;
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("terminal_id",39, RESULT);
            }
          return CUP$parser$result;
		...
		String sym = (String)CUP$parser$stack.peek().value;
          ...
          RESULT = sym;
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("term_id",40, RESULT);
            }
          return CUP$parser$result;
		...
		String start_name = (String)CUP$parser$stack.peek().value;
          ...
          if (nt == null)
          ...
          else
            {
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("NT$10",55, RESULT);
            }
          return CUP$parser$result;
		...
		String lhs_id = (String)CUP$parser$stack.peek().value;
          ...
          new_rhs();
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("NT$11",56, RESULT);
            }
          return CUP$parser$result;
 ...
 ErrorManager.getManager().emit_error("Syntax Error"); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("NT$12",57, RESULT);
            }
          return CUP$parser$result;
		...
		String labid = (String)CUP$parser$stack.peek().value;
          ...
          if (symb == null)
            {
              if (ErrorManager.getManager().getErrorCount() == 0)
                ErrorManager.getManager().emit_error("ldf.java_cup.runtime.Symbol \"" + symid +
                               "\" has not been declared");
            }
          else
            {
		...
		String labid = (String)CUP$parser$stack.peek().value;
		 RESULT = labid; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("opt_label",38, RESULT);
            }
          return CUP$parser$result;
 ...
 multipart_names.push(multipart_name); multipart_name="";
              CUP$parser$result = parser.getSymbolFactory().newSymbol("NT$13",58, RESULT);
            }
          return CUP$parser$result;
		...
		String arg = (String)CUP$parser$stack.peek().value;
		 RESULT = arg; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("typearglist",42, RESULT);
            }
          return CUP$parser$result;
		...
		String arg = (String)CUP$parser$stack.peek().value;
		 RESULT = list + "," + arg; 
          ...
          case 78: // typearguement ::= type_id 
            {
              String RESULT =null;
		 RESULT = multipart_name; multipart_name = ""; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("typearguement",43, RESULT);
            }
          return CUP$parser$result;
          ...
          case 80: // wildcard ::= QUESTION 
            {
              String RESULT =null;
		 RESULT = " ? "; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("wildcard",44, RESULT);
            }
          return CUP$parser$result;
          ...
          case 81: // wildcard ::= QUESTION EXTENDS type_id 
            {
              String RESULT =null;
		 RESULT = " ? extends "+multipart_name; multipart_name = ""; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("wildcard",44, RESULT);
            }
          return CUP$parser$result;
          ...
          case 82: // wildcard ::= QUESTION SUPER type_id 
            {
              String RESULT =null;
		 RESULT = " ? super "+multipart_name; multipart_name = ""; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("wildcard",44, RESULT);
            }
          return CUP$parser$result;
		...
		String term_id = (String)CUP$parser$stack.peek().value;
          ...
          if (symbols.get(term_id) != null)
            {
              /* issue a message */
              ErrorManager.getManager().emit_error("ldf.java_cup.runtime.Symbol \"" + term_id +
		...
		String non_term_id = (String)CUP$parser$stack.peek().value;
          ...
          if (symbols.get(non_term_id) != null)
            {
              /* issue a message */
              ErrorManager.getManager().emit_error( "ldf.java_cup.runtime.Symbol \"" + non_term_id +
                                              "\" has already been declared");
            }
          else
            {
		...
		String the_id = (String)CUP$parser$stack.peek().value;
		 RESULT = the_id; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("nt_id",35, RESULT);
            }
          return CUP$parser$result;
		...
		String the_id = (String)CUP$parser$stack.peek().value;
		 RESULT = the_id; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("symbol_id",36, RESULT);
            }
          return CUP$parser$result;
		...
		String the_id = (String)CUP$parser$stack.peek().value;
		 RESULT = the_id; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("label_id",37, RESULT);
            }
          return CUP$parser$result;
		...
		String the_id = (String)CUP$parser$stack.peek().value;
		 RESULT = the_id; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("robust_id",41, RESULT);
            }
          return CUP$parser$result;
  ...
  public final ldf.java_cup.runtime.Symbol CUP$parser$do_action(
    int                        CUP$parser$act_num,
    ldf.java_cup.runtime.lr_parser CUP$parser$parser,
    java.util.Stack<Symbol>    CUP$parser$stack,
    int                        CUP$parser$top)
